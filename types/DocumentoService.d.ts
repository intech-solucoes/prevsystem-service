...
declare class DocumentoService extends BaseService {
    ...
    BuscarPorPlanoPasta: (cdPlano: string, oidPasta?: null) => Promise<any>;
    Criar: (OID_ARQUIVO_UPLOAD: number, TXT_TITULO: string, IND_ATIVO: string, NUM_ORDEM: number, CD_PLANO?: null, OID_DOCUMENTO_PASTA?: null) => Promise<any>;
