...
var FichaFinanceiraAssistidoService = /** @class */ (function (_super) {
    ...
    function FichaFinanceiraAssistidoService() {
        ...
        _this.BuscarUltimaPorPlanoEspecie = function (cdPlano, cdEspecie) {
            return _this.CriarRequisicao(service_1.TipoRequisicao.GET, null, "ultimaFolhaPorPlano/" + cdPlano + "/" + cdEspecie);
        };
