...
var InfoRendService = /** @class */ (function (_super) {
    __extends(InfoRendService, _super);
    function InfoRendService() {
        var _this = _super.call(this, "infoRend") || this;
        _this.BuscarReferencias = function () {
            return _this.CriarRequisicao(service_1.TipoRequisicao.GET, null, "referencias");
        };
...
exports.default = new InfoRendService();
