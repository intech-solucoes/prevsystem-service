...
var FichaFechamentoPrevesService = /** @class */ (function (_super) {
    __extends(FichaFechamentoPrevesService, _super);
    function FichaFechamentoPrevesService() {
    ...
    return FichaFechamentoPrevesService;
}(service_1.BaseService));
exports.default = new FichaFechamentoPrevesService();
